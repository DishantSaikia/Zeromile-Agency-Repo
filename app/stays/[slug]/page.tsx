...
// Stays are managed from /admin - no generateStaticParams, since a
// prebuilt slug list would conflict with wanting a newly-added stay's page
// to work immediately, without a rebuild.
...
export async function generateMetadata({ params }: { params: Promise<Params> }): Promise<Metadata> {
  ...
  return {
    title,
    description,
    openGraph: { title, description, images: getListingImages(stay).map((i) => i.src) },
  };
}
    ...
    >
      <div className="grid gap-10 lg:grid-cols-[1.5fr_1fr] lg:gap-12">
        <div>
          ...
          <h2 className="mt-10 font-heading text-lg tracking-tight text-ink">Amenities</h2>
          ...
          <h2 className="mt-10 font-heading text-lg tracking-tight text-ink">Location</h2>
