...
const title = "About";
const description = `${agencyConfig.tagline} Learn how ${agencyConfig.name} runs self-drive car, commercial fleet, and stay bookings over WhatsApp.`;
    ...
    <>
      ...
      >
        <p className="max-w-2xl text-base leading-relaxed text-ink-muted">
          Today that means three things under one roof: self-drive cars for people who just need to get
